  ...
  context 'with an expert signed in' do
    ...
    describe '#create_avis' do
      ...
      before do
        ...
        post :create_avis, params: { id: previous_avis.id, procedure_id: procedure.id, avis: { emails: emails, experts_procedure: experts_procedure, introduction: intro, confidentiel: asked_confidentiel, invite_linked_dossiers: invite_linked_dossiers, introduction_file: @introduction_file } }
        created_avis.reload
      end
      after { Timecop.return }
